...
abstract: I originally built this portfolio in 2024, and since then it's evolved quite a bit. Recently I migrated from Create React App to Next.js and made some major upgrades in the process.
date: '2024-08-21'
